...
| ---------------------------------------- | ------------------------- |
| Reading reflections (~2 per week)        | 25% [80% is 100% Rule]    |
| Final project                            | 20%                       |
| Quizzes (3-5)                            | 15%                       |
| Assignments (3)                          | 15%                       |
...
- You are strongly advised to scope your final project to be achievable using the computing resources you already have access to (e.g. Google Colab Pro for Education, your laptop, GPUs that you may have access to). If you are excited about an idea that requires additional compute, please talk to me about this early on (_before_ the proposal is due).

## Other Course Policies

### Academic integrity

All students are expected to be familiar with, and to comply with, the [University Policy on Academic Integrity](https://www.cmu.edu/policies/student-and-student-life/academic-integrity.html)

List of **course-specific academic integrity rules**. I reserve the right to impose a significant penalty to your grade and write you up for an academic integrity violation if you do not follow these rules.

- _Do not_ use AI to assist in writing your reading reflections. I'll know, and you won't learn anything.
- You may use AI to aid in your reading of papers, e.g., to ask clarifying questions about the material that you're reading.
- _Do not_ use AI to complete the close-ended sections of your assignments. I'll know, and you won't learn anything.
- Respect the rules for [collaboration](#collaboration) below.

### Collaboration

You must **complete the following activities entirely on your own, without consulting your peers**: reading reflections, quizzes, close-ended sections of assignments, peer presentation feedback, paper presentations, and final project peer review.

You may **complete the following activities in collaboration with at most one other peer**: open-ended sections of assignments, and the final project.

Despite these restrictions, we do want this class to feel very collaborative! There will be regular opportunities in class to work with your peers and discuss ideas in small groups.

### Accommodation

If you have a disability requiring accommodation, please contact Catherine Getchell, Director of Disability Resources, 412-268-6121, getchell@cmu.edu. If you have an accommodation letter from the Disability Resources office, I encourage you to discuss your accommodations and needs with me as early in the semester as possible. If you are experiencing other life circumstances for which an accommodation would be necessary, please also discuss this with me early in the semester. I will work with you to ensure that accommodations are provided as appropriate.
